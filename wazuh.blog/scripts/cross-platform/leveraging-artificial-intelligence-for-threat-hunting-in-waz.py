<!-- Source: https://wazuh.com/blog/leveraging-artificial-intelligence-for-threat-hunting-in-wazuh/ | Article: Leveraging artificial intelligence for threat hunting in Wazuh -->
import json
import os
import gzip 
